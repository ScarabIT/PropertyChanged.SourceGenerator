...
public readonly record struct AlsoNotifyMember : IMember, IEquatable<AlsoNotifyMember>
{
    ...
    public static AlsoNotifyMember FromMemberAnalysis(MemberAnalysisBuilder memberAnalysis) =>
        new(memberAnalysis.Property.Name, memberAnalysis.Type, memberAnalysis.OnPropertyNameChanged, memberAnalysis.OnPropertyNameChanging);
